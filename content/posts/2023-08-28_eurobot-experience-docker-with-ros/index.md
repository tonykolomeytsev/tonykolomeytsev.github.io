...
<!-- TODO: картинка с демонстрацией нод, общающихся при помощи топиков -->
...
## Триггер к изменениям
<!-- Тут рассказать про предложение ненашева использовать докер и первичные причины, по которым хотелось его использовать -->
